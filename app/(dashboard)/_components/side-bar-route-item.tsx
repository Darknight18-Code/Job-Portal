...
const SideBarRouteItem = ({
  ...
  return (
    <button onClick={onClick} className={cn("flex items-center gap-x-2 text-neutral-500 test-sm font-[500] pl-6               transition-all hover:text-neutral-600 hover:bg-neutral-400/20",
